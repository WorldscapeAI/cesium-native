...
struct CESIUMGLTFCONTENT_API GltfUtilities {
   ...
   * will be @ref CesiumGeospatial::GlobeRectangle::EMPTY, its minimum height
   * will be 1.0, and its maximum height will be -1.0 (the minimum will be
  ...
  /**
   * @brief Copies the content of one @ref CesiumGltf::Buffer to the end of
   * another, updates all @ref CesiumGltf::BufferView instances to refer to the
   * destination buffer, and clears the contents of the original buffer.
   *
